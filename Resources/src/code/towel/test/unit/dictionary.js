Ti.include('/src/code/towel/test/include.js');
    ...
    dictionary = require('src/code/towel/dictionary');
    ...
    function Test_heritage()
    {
        ...
        { 
            assertSimilar( dictionary.heritage([1, 2, 3]), [
                ['Array' , [0, 1, 2, 'length']],
                ['Array' , ['length', 'constructor', 'forEach', 'some', 'every', 'map', 'filter', 'reduce', 'reduceRight', 'push', 'pop', 'reverse', 'sort', 'join', 'shift', 'unshift', 'concat', 'indexOf', 'lastIndexOf', 'slice', 'splice', 'toString', 'toLocaleString']],
